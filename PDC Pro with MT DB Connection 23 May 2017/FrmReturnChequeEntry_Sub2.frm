VERSION 5.00
Begin VB.Form FrmReturnChequeEntry_Sub2 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ...
   End
End
Attribute VB_Name = "FrmReturnChequeEntry_Sub2"
