...
Begin VB.Form FrmReturnChequeEntry_Sub1 
   BackColor       =   &H80000005&
   ...
   Begin VB.ComboBox cboReason 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "FrmReturnChequeEntry_Sub1.frx":0000
      Left            =   3000
      List            =   "FrmReturnChequeEntry_Sub1.frx":0028
   ...
   End
End
Attribute VB_Name = "FrmReturnChequeEntry_Sub1"
...
With FrmReturnChequeEntry_Sub2
    ...
    If cboReason.Text = "Wrong Cheque" Then
        .lblRemarks.Caption = "Remarks: " & vbCrLf & Me.txtRemarks.Text
        .lblRemarks1.Caption = "Remarks: " & vbCrLf & Me.txtRemarks.Text
    ElseIf cboReason.Text = "30 Days Diff in Chq Date" Then
        .lblRemarks.Caption = "Remarks: " & vbCrLf & Me.txtRemarks.Text
        .lblRemarks1.Caption = "Remarks: " & vbCrLf & Me.txtRemarks.Text
    End If
    ...
    .PrintForm
End With
Unload FrmReturnChequeEntry_Sub2
Exit Sub
...
If Not (rs1.BOF And rs1.EOF) Then
    rs1!ReturnFlag = 1
    rs1!ReturnDate = dtEntry.Value
    rs1!ReturnReason = Me.cboReason.Text
    
    If cboReason.Text = "30 Days Diff in Chq Date" Then
        txtRemarks.Text = "OE Cheque Date: " & Format(rs1!CentreChequeDate, "dd Mmm yyyy") & ", Actual Cheque Date: " & Format(rs1!CCChequeDate, "dd Mmm yyyy")
    End If
