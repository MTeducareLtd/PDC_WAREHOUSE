VERSION 5.00
Begin VB.Form FrmInwardEntry_Sub1 
   BackColor       =   &H80000005&
   ...
   Begin VB.ComboBox cboStatus 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "FrmInwardEntry_Sub1.frx":0000
      Left            =   2520
      List            =   "FrmInwardEntry_Sub1.frx":000D
   ...
   End
End
Attribute VB_Name = "FrmInwardEntry_Sub1"
...
str = "Select * from ASPDC_DispatchSlipLog where DispatchSlipCode ='" & Trim(UCase(Me.txtSlipNo.Text)) & "' and (InwardFlag is Null or Inwardflag =0)"
...
rs1.Open "Select * from ASPDC_DispatchSlipLog where DispatchSlipCode ='" & txtSlipNo.Text & "'", cn1, adOpenDynamic, adLockPessimistic
If Not (rs1.BOF And rs1.EOF) Then
