<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ChequesBounced.aspx.vb" Inherits="ChequesBounced" %>
 ...
 <div id="main-content" class="clearfix">
        <div id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Bounced Cheques</li>
            </ul>
            <!--.breadcrumb-->
                                            ...
                                            <div class="slim-scroll">
                                                <table id="table2" runat="server">
                                                    <tr id="Tr2" runat="server">
                                                            ...
                                                            <div class="row-fluid">
						                                        ...
						                                        <%--<div class="input-append">--%>
							                                        <asp:ListBox ID="ddlCentre"  runat="server" class="chzn-select" 
                                                                     data-placeholder="Search Centres..." SelectionMode="Multiple" >
                                                                    </asp:ListBox>
                                                        ...
                                                        <td>
                                                            <div class="row-fluid">
                                                                <label for="ddlCentre">From Date</label>
                                                                <div class="input-prepend">
                                                                <span class="add-on"><i class="icon-calendar"></i></span>
                                                                <input runat ="server" class="span10 date-picker" id="id_date_picker_1" type="text" data-date-format="dd-mm-yyyy" />
                                                                </div> 
                ...
                <div id="table_report_wrapper" class="dataTables_wrapper" role="grid" visible="false"
                    ...
                    <asp:DataList ID="dlReport" class="table table-striped table-bordered table-hover" runat="server" Width="100%">
                        ...
                        <ItemTemplate>
                                    ...
                                    <td style="width: 10%" align="left">
                                        <asp:Label ID="Label2" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"sbentrycode" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="left">
                                        <asp:Label ID="lblurl" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"studentname")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="left">
                                        <asp:Label ID="Label3" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ChequeNo")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="left">
                                        <asp:Label ID="Label4" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ChequeDate")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="left">
                                        <asp:Label ID="Label5" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ChequeAmt")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="left">
                                        <asp:Label ID="Label7" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CMSSlipNo")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="left">
                                        <asp:Label ID="Label6" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"HoldStatus")%>'></asp:Label>
                                    </td> 
                                    <td style="width: 10%" align="left">
                                        <asp:Label ID="Label8" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ChequeLocation")%>'></asp:Label>
                                    </td> 
                                    <td style="width: 10%" align="left">
                                        <asp:LinkButton ID="lnkRemarks" CommandName="Remarks"  runat="server" class="btn btn-small btn-info icon-edit"
                                        CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ChequeNo")%>' ToolTip="Remarks" />    
                        </ItemTemplate>
                    </asp:DataList>
                    <asp:DataList ID="dlReportForExport" class="table table-striped table-bordered table-hover" runat="server" Width="100%" Visible ="false" >
                        <HeaderTemplate>
