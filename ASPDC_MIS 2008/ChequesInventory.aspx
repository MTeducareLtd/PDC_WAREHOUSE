<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ChequesInventory.aspx.vb" Inherits="ChequesInventory" %>
    ...
    <div id="main-content" class="clearfix">
        <div id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Cheques Inventory</li>
            </ul>
            <!--.breadcrumb-->
                ...
                <div id="table_report_wrapper" class="dataTables_wrapper" role="grid" visible="false"
                    ...
                    <asp:DataList ID="dlReport" class="table table-striped table-bordered table-hover" runat="server" Width="100%">
                        ...
                        <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"centrename" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="Label1" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"OpeningStock" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="Label2" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"OpeningStockVal" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="lblurl" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"InwardStock")%>'></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="Label3" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"InwardStockVal")%>'></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="Label4" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"CMSCnt")%>'></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="Label5" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"CMSVal")%>'></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="Label6" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"ReturnCnt")%>'></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="Label7" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"ReturnVal")%>'></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="Label8" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"FinalStockCnt")%>'></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="Label9" runat="server" class="pull-right"  Text='<%#DataBinder.Eval(Container.DataItem,"FinalStockVal")%>'></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                                        <asp:Label ID="lblF1" runat="server" Text='Total'></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="lblF2" runat="server" class="pull-right"   Text=''></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="lblF3" runat="server" class="pull-right"   Text=''></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="lblF4" runat="server" class="pull-right"   Text=''></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="lblF5" runat="server" class="pull-right"   Text=''></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="lblF6" runat="server" class="pull-right"   Text=''></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="lblF7" runat="server" class="pull-right"   Text=''></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="lblF8" runat="server" class="pull-right"   Text=''></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="lblF9" runat="server" class="pull-right"   Text=''></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="lblF10" runat="server" class="pull-right"   Text=''></asp:Label>
                                    </td>
                                    <td style="width: 9%" align="right">
                                        <asp:Label ID="lblF11" runat="server" class="pull-right"   Text=''></asp:Label>
                        </FooterTemplate> 
                    </asp:DataList>
