<%@ Page Title="" Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="ChequesNotDispatched.aspx.vb" Inherits="User_Panel_ConfigCity" %>
    ...
    <div id="main-content" class="clearfix">
        <div id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Cheques not dispatched</li>
            </ul>
            <!--.breadcrumb-->
                                            ...
                                            <div class="slim-scroll">
                                                <table id="table2" runat="server">
                                                    <tr id="Tr2" runat="server">
                                                        ...
                                                        <td>
                                                            <div class="row-fluid">
                                                                <label for="ddlCentre">Report Type</label>
                                                                <asp:Dropdownlist ID="ddlReportType"  runat="server" class="chzn-select" 
                    ...
                    <asp:DataList ID="dlReport" class="table table-striped table-bordered table-hover" runat="server" Width="100%">
                        ...
                        <ItemTemplate>
                                    ...
                                    <td style="width: 10%" align="left">
                                        <asp:Label ID="Label3" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"chkno")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="left">
                                        <asp:Label ID="Label4" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"chkdate")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="left">
                                        <asp:Label ID="Label6" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Paydate")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="left">
                                        <asp:Label ID="Label5" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"amountpaid")%>'></asp:Label>
