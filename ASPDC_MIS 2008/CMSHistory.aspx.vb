...
Partial Class CMSHistory
    ...
    Protected Sub btnSearchRecord_Click(sender As Object, e As System.EventArgs) Handles btnSearchRecord.Click
        ...
        Try
            Dim da As New SqlDataAdapter("SP_ASPDC_CMSSummary", conn)
    ...
    Protected Sub btnExport_Click(sender As Object, e As System.EventArgs) Handles btnExport.Click
        ...
        Response.AddHeader("content-disposition", "attachment;filename=CMSHistory.xls")
