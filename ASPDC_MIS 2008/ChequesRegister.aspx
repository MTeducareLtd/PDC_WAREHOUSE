<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ChequesRegister.aspx.vb" Inherits="ChequesRegister" %>
    ...
    <div id="main-content" class="clearfix">
        <div id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Cheques Register</li>
            </ul>
            <!--.breadcrumb-->
                                                ...
                                                <table id="table2" runat="server">
                                                    <tr id="Tr2" runat="server">
                                                        <td>
                                                         ...
                                                         <td>
                                                            <div class="row-fluid">
                                                                <label for="ddlCentre">Centre Name</label>
						                                        <%--<div class="input-append">--%>
							                                        <asp:ListBox ID="ddlCentre"  runat="server" class="chzn-select" 
                                                                     data-placeholder="Search Centres..." SelectionMode="Single" AutoPostBack="True">
                                                                    </asp:ListBox>
                                                        ...
                                                        <td>
                                                            <div class="row-fluid">
                                                                <label for="ddlSlipNo">Dispatch Slip No</label>
                                                                <asp:ListBox ID="ddlSlipNo"  runat="server" class="chzn-select" 
                                                                     data-placeholder="Select Slip No..." SelectionMode="Multiple" >
                                                                    </asp:ListBox>
                                                     ...
                                                     <tr id="Tr1" runat="server">
                                                        <td>
                                                            <div class="row-fluid">
                                                                <label for="ddlDivision">Cheque Number<small class="text-warning">*</small></label>
						                                        <asp:TextBox runat ="server" class="span12" ID ="txtChequeNo"></asp:TextBox> 
                                                         ...
                                                         <td>
                                                            <div class="row-fluid">
                                                                <label for="ddlCentre">Barcode Number</label>
						                                        <%--<div class="input-append">--%>
							                                        <asp:TextBox runat ="server" class="span12" ID ="txtBarcode"></asp:TextBox> 
                                                        ...
                                                        <td>
                                                            <div class="row-fluid">
                                                                <label for="ddlSlipNo">SBEntryCode</label>
                                                                <div class="input-append">
                                                                <asp:TextBox runat ="server" class="span12" ID ="txtSBEntryCode"></asp:TextBox> 
                ...
                <div id="table_report_wrapper" class="dataTables_wrapper" role="grid" visible="false"
                    ...
                    <asp:DataList ID="dlReport" class="table table-striped table-bordered table-hover" runat="server" Width="100%">
                        ...
                        <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"DispatchSlipCode" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 8%" align="left">
                                        <asp:Label ID="Label8" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"DispatchDate" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 8%" align="left">
                                        <asp:Label ID="Label9" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"SlipEntryDate" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 8%" align="left">
                                        <asp:Label ID="Label1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CCCHQIdNo" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 8%" align="left">
                                        <asp:Label ID="Label6" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"StreamName" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 8%" align="left">
                                        <asp:Label ID="Label7" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"SBEntryCode" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 12%" align="left">
                                        <asp:Label ID="Label2" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"studentname" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 8%" align="left">
                                        <asp:Label ID="lblurl" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CenterChequeNo")%>'></asp:Label>
                                    </td>
                                    <td style="width: 8%" align="left">
                                        <asp:Label ID="Label3" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CentreChequeDate")%>'></asp:Label>
                                    </td>
                                    <td style="width: 8%" align="left">
                                        <asp:Label ID="Label4" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CentreChequeAmt")%>'></asp:Label>
                                    </td>
                                    <td style="width: 8%" align="left">
                                        <asp:Label ID="Label5" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ChqStatus")%>'></asp:Label>
                                    </td>
                                    <td style="width: 8%" align="left">
                                        <asp:Label ID="Label10" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CMSSlipDate")%>'></asp:Label>
                                    
                        </ItemTemplate>
                    </asp:DataList>
                    <asp:DataList ID="dlReportSummary" class="table table-striped table-bordered table-hover" runat="server" Width="100%" Visible ="false">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                                    ...
                                    <td style="width: 15%" align="left">
                                        <asp:Label ID="Label2" class= "pull-right"  runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"sbentrycode" )%>'></asp:Label>
                                    </td>
                                    
                                    <td style="width: 15%" align="left">
                                        <asp:Label ID="Label5" class= "pull-right"  runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"amountpaid")%>'></asp:Label>
