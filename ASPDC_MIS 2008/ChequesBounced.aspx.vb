...
Partial Class ChequesBounced
    ...
    Protected Sub btnSearchRecord_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchRecord.Click
        ...
        Dim da As New SqlDataAdapter("SP_ASPDC_CMSBounced", conn)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                dlReportForExport.DataSource = ds
                dlReportForExport.DataBind()
            ...
            Else
                ...
                dlReportForExport.DataSource = Nothing
                dlReportForExport.DataBind()
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        dlReportForExport.Visible = True
        Response.Clear()
        ...
        dlReportForExport.RenderControl(htmlWrite)

        Response.Write(stringWrite.ToString())

        Response.End()
        dlReportForExport.Visible = False
