<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="CMSProjections.aspx.vb" Inherits="CMSProjections" %>
    ...
    <div id="main-content" class="clearfix">
        <div id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">CMS Projections</li>
            </ul>
            <!--.breadcrumb-->
                ...
                <div id="table_report_wrapper" class="dataTables_wrapper" role="grid" visible="false"
                    ...
                    <asp:DataList ID="dlReport" class="table table-striped table-bordered table-hover" runat="server" Width="100%">
                        ...
                        <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CMSSlipDate" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="right">
                                        <asp:Label ID="Label1" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"CMSValueSci" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="right">
                                        <asp:Label ID="Label2" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"CMSValueCOM" )%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="right">
                                        <asp:Label ID="lblurl" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"CMSValueCBSE")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="right">
                                        <asp:Label ID="Label3" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"CMSValueICSE")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="right">
                                        <asp:Label ID="Label4" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"CMSValueUVA")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="right">
                                        <asp:Label ID="Label5" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"CMSValueSTBM")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="right">
                                        <asp:Label ID="Label6" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"CMSValueSTB")%>'></asp:Label>
                                    </td>
                                    <td style="width: 10%" align="right">
                                        <asp:Label ID="Label7" runat="server" class="pull-right"   Text='<%#DataBinder.Eval(Container.DataItem,"CMSValueTotal")%>'></asp:Label>
